...
-   [What's the difference between a web server and an app server?](https://www.techtarget.com/searchdatamanagement/definition/database)
-   [DNS record types](https://www.techtarget.com/searchdatamanagement/definition/database)
